type Props = {
  ...
  region: string;
  category: string;
  variant?: "gold" | "teal" | "sage";
};

const palettes = {
  gold: { ring: "#c9a04b", bg: "#fdf6e6", ink: "#7a4a00", accent: "#a87f2c" },
  teal: { ring: "#0e6e7d", bg: "#e9f4f5", ink: "#08515c", accent: "#0e6e7d" },
  sage: { ring: "#88a59d", bg: "#eef3f1", ink: "#3f5e54", accent: "#5a7a70" },
};
